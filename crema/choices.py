...
class EventType(Enum):
    ...
    MOBILE_UPDATION = "MOBILE_UPDATION"
    PHYSICAL_CPV_INFORMATION = "PHYSICAL_CPV_INFORMATION"
    DIGITAL_CPV_INFORMATION = "DIGITAL_CPV_INFORMATION"
    ...
    PL_PRE_DUE_ALLOCATION = "PL_PRE_DUE_ALLOCATION"

    # Hades Internal topic
    I_HADES_COMMUNICATION_EVENTS = "I_HADES_COMMUNICATION_EVENTS"
...
class EventPartition(Enum):
    ...
    USER_UPDATION = 4
    MOBILE_UPDATION = 4
    PHYSICAL_CPV_INFORMATION = 4
    DIGITAL_CPV_INFORMATION = 4
    ...
    PL_PRE_DUE_ALLOCATION = 4

    I_HADES_COMMUNICATION_EVENTS = 8
